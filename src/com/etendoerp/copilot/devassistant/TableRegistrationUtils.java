...
public class TableRegistrationUtils {
   ...
   * @throws OBException if a table or view with the specified name already exists.
   */
   ...
   *
   * @param dataPackage    The data package associated with the table or view.
   * @param javaClass      The Java class name for the table or view.
   * @param tableName      The name of the table or view.
   * @param dataAccessLevel The data access level for the table or view.
   * @param description    The description of the table or view.
   * @param helpTable      Help comment or description for the table or view.
   * @param isView         Indicates if the object is a view.
   ...
   *
   * @param name      The base name of the table or view.
